                ...
                <div class="row g-5">
                    <div class="col-3">
                        ...
                        <div class="foot-body mb-4">
                            <p>In the new era of technology we look a in the future with certainty and pride to for our
                                company and.</p>
                        </div>
                        <div class="foot-link">
                            <a href="#"><img src="{{ asset('assets/images/Footer/1.png') }}"
                                    alt="" /></a>
                            <a href="#"><img src="{{ asset('assets/images/Footer/2.png') }}"
                                    alt="" /></a>
                            <a href="#"><img src="{{ asset('assets/images/Footer/3.png') }}"
                                    alt="" /></a>
                            <a href="#"><img src="{{ asset('assets/images/Footer/4.png') }}"
                                    alt="" /></a>
                        </div>
                    </div>
                    <div class="col-1"></div>
