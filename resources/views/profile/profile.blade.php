    ...
    <section class="container profile py-3">
        ...
        <div class="profile-card container mb-5">
            ...
            <div class="mb-3">
                ...
                <a href="{{ route('profile.edit', $user->id) }}" class="my-1"><button type="submit" class="btn">Edit
                        Profile</button></a>
                {{-- <br> --}}
                <a href="{{ route('book-table') }}" class="my-1"><button type="submit" class="btn">Book A
                        Table</button></a>
                {{-- <br> --}}
                <a href="{{ route('profile.mybooking') }}" class="my-1 mb-3"><button type="submit" class="btn">My
                        Bookings</button></a>
                {{-- <br> --}}
